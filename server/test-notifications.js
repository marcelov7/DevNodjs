...
async function testarNotificacoes() {
    ...
    try {
        // 1. Fazer login com o usuário admin_master criado
        ...
        if (gerenciamentoResponse.data.success) {
            ...
            const usuarios = gerenciamentoResponse.data.data.usuarios;
            console.log(`👥 Usuários na organização: ${usuarios.length}`);
        }
